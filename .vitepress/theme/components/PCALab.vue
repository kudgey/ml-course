 ...
 * рисунку. Відновлення рахується тут-таки за формулою з розділу: zₙW + μ.
 * Числа розділу відтворюються: K = 2 → 29 %, K = 8 → 67 %, K = 16 → 85 %,
...
/** x̂ = z[:K] · W[:K] + μ — рівно та формула, що в розділі. */

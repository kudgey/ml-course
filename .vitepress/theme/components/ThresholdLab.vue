...
/**
 * Поріг класифікації на справжніх передбаченнях моделі зі слайда:
 * логістична регресія на Breast Cancer Wisconsin, відкладені 171 спостереження.
 * Числа слайда відтворюються точно: поріг 0,5 → 4 пропуски і 4 хибні тривоги;
  ...
  <div class="lab">
    <div class="lab__head">
      <div>
        ...
        <div class="lab__sub">
          Справжні передбачення моделі зі слайда: логістична регресія на Breast Cancer
